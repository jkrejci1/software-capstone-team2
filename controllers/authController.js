...
module.exports.signup_post = async (req, res) => {
    ...
    try {
        ...
        const user = await User.create({ email, password, firstName, lastName, number, userStatus, _AboutYourself, weeklyAvailability }) //Async, gives a promise; make sure the function is async then
